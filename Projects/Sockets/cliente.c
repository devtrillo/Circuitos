...
int main(int argc, char **argv)
{
	...
	/*******SERVER*************/
	/*
	int SocketFD=e_i32CreateAndListenTcp(6000);
	...
	/*******CLIENTE*************/
	int socketOut= e_i32CreateAndConnectTcp("192.168.43.139",6001);
	printf("%d\n", socketOut);
	if(socketOut<0)
		return -1;
	...
	while(e_i32ReadInputData(socketOut,p_ptrBuffer,ARRAY_LENGTH)==0);
	printf("Server:%s \n", p_ptrBuffer);
